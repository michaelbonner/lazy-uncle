      ...
      <div className="container mx-auto px-4 text-gray-700 max-w-5xl mt-16">
        ...
        <div className="pt-4 max-w-3xl lg:mx-24">
          ...
          <ol className="ml-8 list-roman" type="a">
            <li className="mt-2">
              ...
              <ol className="ml-8 list-decimal" type="i">
                <li className="mt-2">modify or copy the materials;</li>
                <li className="mt-2">
          ...
          <p className="mt-4">
            ...
            inability to use the materials on Lazy Uncle&apos;s website, even if
            Lazy Uncle or a Lazy Uncle authorized representative has been
          ...
          <p className="mt-4">
            ...
            inclusion of any link does not imply endorsement by Lazy Uncle of
          ...
          <p className="mt-4">
            Lazy Uncle may revise these terms of service for its website at any
