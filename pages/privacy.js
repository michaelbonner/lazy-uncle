...
const Privacy = () => {
  return (
    <div className="container mx-auto">
      ...
      <p className="mt-2">Last updated November 08, 2020</p>

      <p className="mt-2">
        Thank you for choosing to be part of our community at Lazy
        Uncle ("Company", "we", "us", "our"). We are committed to protecting
        ...
        at privacy@lazyuncle.net.
      </p>

      <p className="mt-2">
        When you visit our website https://lazyuncle.net/ (the "Website"), use
      ...
      <p className="mt-2 mb-2">TABLE OF CONTENTS</p>

      <p className="font-semibold">1. WHAT INFORMATION DO WE COLLECT?</p>
      <p className="font-semibold">2. HOW DO WE USE YOUR INFORMATION?</p>
      ...
      <p className="font-semibold">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</p>
      <p className="font-semibold">6. HOW LONG DO WE KEEP YOUR INFORMATION?</p>
      <p className="font-semibold">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</p>
      <p className="font-semibold">8. DO WE COLLECT INFORMATION FROM MINORS?</p>
      <p className="font-semibold">9. WHAT ARE YOUR PRIVACY RIGHTS?</p>
      <p className="font-semibold">10. CONTROLS FOR DO-NOT-TRACK FEATURES</p>
      <p className="font-semibold">
        11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
      </p>
      <p className="font-semibold">12. DO WE MAKE UPDATES TO THIS NOTICE?</p>
      <p className="font-semibold">
      ...
      <p className="mt-2">Personal information you disclose to us</p>
      ...
      <p className="mt-2">Information automatically collected</p>
      ...
      <p className="mt-2">Information collected through our App</p>
      ...
      <p className="mt-2 ml-4">
        ...
        If you wish to update, or delete your testimonial, please contact us
        at privacy@lazyuncle.net and be sure to include your name, testimonial
      ...
      <p className="mt-2">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?     </p>
      ...
      <p className="mt-2">
        ...
        email us at privacy@lazyuncle.net.
      </p>
      ...
      <p className="mt-2">
        ...
        at privacy@lazyuncle.net or by post to:
      </p>

      <p className="mt-2">Lazy Uncle</p>
      <p className="mt-2">P.O. Box 711235</p>
      <p className="mt-2">Salt Lake City, UT 84171</p>
      ...
      <p className="mt-2">
        ...
        please visit: https://lazyuncle.net/forget-me. We will respond to your
