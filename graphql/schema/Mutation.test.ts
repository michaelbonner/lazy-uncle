...
const mockSubmitBirthdayResolver = async (_, args, ctx) => {
...
describe("Submission Management GraphQL Operations", () => {
  ...
  describe("getPendingSubmissions Query", () => {
    const mockGetPendingSubmissionsResolver = async (_, args, ctx) => {
  ...
  describe("importSubmission Mutation", () => {
    const mockImportSubmissionResolver = async (_, args, ctx) => {
  ...
  describe("rejectSubmission Mutation", () => {
    const mockRejectSubmissionResolver = async (_, args, ctx) => {
      const { SubmissionService } = await import(
        "../../lib/submission-service"
      );
  ...
  describe("bulkImportSubmissions Mutation", () => {
    const mockBulkImportResolver = async (_, args, ctx) => {
      const { SubmissionService } = await import(
        "../../lib/submission-service"
      );
  ...
  describe("bulkRejectSubmissions Mutation", () => {
    const mockBulkRejectResolver = async (_, args, ctx) => {
      const { SubmissionService } = await import(
        "../../lib/submission-service"
      );
  ...
  describe("getSubmissionDuplicates Mutation", () => {
    const mockGetDuplicatesResolver = async (_, args, ctx) => {
      const { SubmissionService } = await import(
        "../../lib/submission-service"
      );
