...
const SubmissionReviewInterface = () => {
  ...
  const submissions: BirthdaySubmission[] =
    submissionsData?.pendingSubmissions?.submissions || [];
      ...
      <div className="px-4 py-6 md:px-8">
        ...
        {submissions.length === 0 ? (
          <div className="py-8 text-center">
            ...
            <p className="text-gray-500">
              When people submit birthdays through your sharing links, they'll
        ...
        <div className="mt-6 text-sm text-gray-500">
          <p>
            ...
            you want to add to your birthday list, or reject those you don't
            need.
          </p>
        </div>
      </div>
...
function calculateSimilarity(
  submission: BirthdaySubmission,
  existing: { name: string; date: string; category?: string },
): number {
  let similarity = 0;
  let factors = 0;
